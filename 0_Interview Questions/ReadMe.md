...
156. ### What is the difference between `mapStateToProps()` and `mapDispatchToProps()`?
     ...
     Recommend always using the â€œobject shorthandâ€ form for the `mapDispatchToProps`
...
227. ### What are the rules needs to follow for hooks?
     ...
     1. Call Hooks only at the top level of your react functions. i.e, You shouldnâ€™t call Hooks inside loops, conditions, or nested functions. This will ensure that Hooks are called in the same order each time a component renders and it preserves the state of Hooks between multiple useState and useEffect calls.
     2. Call Hooks from React Functions only. i.e, You shouldnâ€™t call Hooks from regular JavaScript functions.
...
268. ### Is it keys should be globally unique?
     Keys used within arrays should be unique among their siblings but they donâ€™t need to be globally unique. i.e, You can use the same keys with two different arrays.
...
271. ### Why do you not required to use inheritance?
     In React, it is recommend using composition instead of inheritance to reuse code between components. Both Props and composition give you all the flexibility you need to customize a componentâ€™s look and behavior in an explicit and safe way.
...
295. ### What is the typical use case of portals?
     React portals are very useful when a parent component has overflow: hidden or has properties that affect the stacking context(z-index,position,opacity etc styles) and you need to visually â€œbreak outâ€ of its container.
